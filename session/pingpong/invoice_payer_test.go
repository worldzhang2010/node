...
func (mcts *mockConsumerTotalsStorage) Store(id identity.Identity, accountantAddress common.Address, amount uint64) error {
...
func (mcts *mockConsumerTotalsStorage) Get(id identity.Identity, accountantAddress common.Address) (uint64, error) {
	mcts.resLock.Lock()
