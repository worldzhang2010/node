...
func (cm *mockConnectionManager) Connect(consumerID identity.Identity, accountantAddress common.Address, proposal market.ServiceProposal, options connection.ConnectParams) error {
	cm.requestedConsumerID = consumerID
	cm.requestedAccountantID = accountantAddress
